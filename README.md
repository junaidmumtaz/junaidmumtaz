...
- Threat Hunting: Using KQL, SIEM queries, and threat intelligence to proactively identify threats  
- Log Management & Analysis: Centralizing logs from endpoints, networks, and cloud sources  
- SIEM Engineering: Microsoft Sentinel, Splunk, IBM QRadar, Wazuh  
- SOAR Automation: IBM Resilient, SIRP, cloud-native SOAR playbooks  
- Endpoint & Network Security: EDR/XDR solutions (Defender XDR, Carbon Black), network monitoring (Cisco, Fortinet, Palo Alto)  
...
- XDR: Microsoft Defender XDR, Cortex (Palo Alto Networks)  
- EDR: Trend Micro, Carbon Black, Palo Alto, Kaspersky, Symantec EPP  
- NDR: Cisco Stealthwatch  
- Network: Cisco, Fortinet, Palo Alto, FortiAnalyzer  
- DRP: Recorded Future  
- OS: Windows, Linux  
